...
const initialEquipment = [
  {
    name: "Трактор 404D6ZU",
    image: "/images/tractor-404dg2u.jpg",
    quantity: 5,
    type: "трактор",
    category: "Трактори",
    details: "Потужність: 40 к.с.<br>Гідравлічний вихід",
    link: "/pages/traktor404dg2u.html",
    price: 1000.0,
    usage_count: 10,
  },
  {
    name: "Культиватор Кентавр МБ40-1С/G",
    image: "/images/cultivator-kentavr-mb40-1c6.jpg",
    quantity: 3,
    type: "культиватор",
    category: "Культиватори",
    details: "Ширина захвату: 100 см<br>Вага: 90 кг",
    link: "/pages/kultivator_kentavr_mb40.html",
    price: 500.0,
    usage_count: 20,
  },
  {
    name: "Комбайн CAT Lexion 470R",
    image: "/images/combine-cat-lexion-470r.jpg",
    quantity: 2,
    type: "комбайн",
    category: "Комбайни",
    details: "Напрацювання: 3 106 м/год<br>Двигун: 290 к.с.",
    link: "/pages/kombajn_dongfeng_df204.html",
    price: 2000.0,
    usage_count: 60,
  },
  {
    name: "Обприскувач навісний",
    image: "/images/6352693431_w640_h640_6352693431.jpg",
    quantity: 4,
    type: "обприскувач",
    category: "Обприскувачі",
    details: "Об'єм бака: 400 л<br>Ширина захвату: 12 м",
    link: "/pages/6352693431_w640_h640_6352693431.html",
    price: 300.0,
    usage_count: 15,
  },
  {
    name: "Комбайн YTO 4LZ-8B1",
    image: "/images/komb-300x300.jpg",
    quantity: 1,
    type: "комбайн",
    category: "Комбайни",
    details: "Об'єм бака: 300 л<br>Ширина захвату: 12 м",
    link: "#",
    price: 1800.0,
    usage_count: 30,
  },
  {
    ...
    type: "плуг",
    category: "Плуги",
    details: "Кількість корпусів: 3<br>Ширина захвату: 120 см",
    link: "#",
    price: 400.0,
    usage_count: 25,
  },
  {
    name: "Плуг ПН-3-35",
    image: "/images/plygiiiiii.png",
    quantity: 3,
    type: "плуг",
    category: "Плуги",
    details: "Кількість корпусів: 3<br>Ширина захвату: 15 м",
    link: "#",
    price: 450.0,
    usage_count: 40,
  },
  {
    name: "Плуг ПН-225",
    image: "/images/Plug 2korp.jpg",
    quantity: 4,
    type: "плуг",
    category: "Плуги",
    details: "Кількість корпусів: 2<br>Потужність: 22-25 к.с.",
    link: "#",
    price: 350.0,
    usage_count: 10,
  },
  {
    name: "Трактор Xingtai XT-900",
    image: "/images/xingtai XT.png",
    quantity: 2,
    type: "трактор",
    category: "Трактори",
    details: "Потужність: 90 к.с.<br>Ємність бака: 800 л",
    link: "#",
    price: 1500.0,
    usage_count: 55,
  },
  {
    name: "Культиватор КПС-8МРП",
    image: "/images/unnamed (1).jpg",
    quantity: 3,
    type: "культиватор",
    category: "Культиватори",
    details: "Ширина захвату: 150 см<br>Глибина: до 30 см",
    link: "#",
    price: 600.0,
    usage_count: 30,
  },
  {
    name: "Плуг ПН 220",
    image: "/images/plug-pn-220-2024-03-1000x1000.jpg",
    quantity: 5,
    type: "плуг dawg",
    category: "Плуги",
    details: "Кількість корпусів: 3<br>Ширина захвату: 120 см",
  ...
  {
    name: "Дощувальні машини",
    image: "/images/oroshenie-dogdevalnye-mashyny.jpg",
    quantity: 2,
    type: "обприскувач",
    category: "Обприскувачі",
    details: "Об'єм бака: 600 л<br>Ширина захвату: 15 м",
    link: "#",
    price: 700.0,
    usage_count: 5,
  },
...
const initialReminders = [
  {
    user_id: 1,
    text: "Технічне обслуговування Трактора 404D6ZU",
    reminder_label: "Техогляд Трактора 404",
    card_title: "Олег",
    dateTime: "2025-04-20T10:00:00",
    completed: 0,
    status: "planned",
    equipment: "Трактор 404D6ZU",
    operator: "Іван Петров",
    taskType: "maintenance",
  },
  {
    user_id: 1,
    text: "Заміна масла в Комбайні CAT Lexion 470R",
    reminder_label: "5",
    card_title: "Заміна Масла Комбайн",
    dateTime: "2025-04-18T14:00:00",
    completed: 0,
    status: "planned",
    equipment: "Комбайн CAT Lexion 470R",
    operator: "Олена Сидоренко",
    taskType: "maintenance",
  },
  {
    user_id: 2,
    text: "Перевірка Культиватора Кентавр МБ40-1С/G",
    reminder_label: "Перевірка Культиватора",
    card_title: "Культиватор Перевірка",
    dateTime: "2025-04-22T09:00:00",
    completed: 0,
    status: "planned",
    equipment: "Культиватор Кентавр МБ40-1С/G",
    operator: "Петро Іванов",
    taskType: "maintenance",
  },
];
...
const initialTasks = [
  {
    name: "Технічне обслуговування трактора",
...
const initialInventory = [
  {
    ...
    quantity: 3,
    min_level: 5,
    responsible: "Адмін Іван",
    update_date: "2025-04-17",
    notes: "Для трактора 404D6ZU",
  },
  {
    user_id: 1,
  ...
  },
  {
    ...
    quantity: 8,
    min_level: 8,
    responsible: "Менеджер Олена",
    update_date: "2025-04-17",
    notes: "Для культиватора",
  },
];
...
async function initializeDb() {
  try {
    ...
    if (!tableNames.includes("expense_records")) {
      ...
      await db.exec(
        `CREATE INDEX idx_expense_records_expense_type ON expense_records (expense_type)`
      );
      await db.exec(
    ...
    if (!tableNames.includes("reminders")) {
      ...
      for (const col of columnsToAdd) {
        if (!reminderColumns.some((c) => c.name === col.name)) {
          console.log(
            `Стовпець ${col.name} відсутній у таблиці reminders, додаємо...`
          );
          await db.exec(
    ...
    if (!tableNames.includes("moto_time")) {
      ...
      await db.exec(`
            ...
            `);
      await db.exec(
        `CREATE INDEX idx_moto_time_user_id ON moto_time (user_id)`
      );
    ...
    if (!tableNames.includes("usage_records")) {
      ...
      await db.exec(
        `CREATE INDEX idx_usage_records_equipment_class ON usage_records (equipment_class)`
      );
    ...
    if (!tableNames.includes("maintenance_history")) {
      ...
      await db.exec(
        `CREATE INDEX idx_maintenance_history_reminder_id ON maintenance_history (reminder_id)`
      );
      ...
      const historyColumns = await db.all(
        `PRAGMA table_info(maintenance_history)`
      );
      if (!historyColumns.some((c) => c.name === "reminder_id")) {
        console.log(
          "Стовпець reminder_id відсутній у таблиці maintenance_history, додаємо..."
        );
        await db.exec(
          `ALTER TABLE maintenance_history ADD COLUMN reminder_id INTEGER`
        );
        await db.exec(
          `CREATE INDEX idx_maintenance_history_reminder_id ON maintenance_history (reminder_id)`
        );
        console.log(
          "Стовпець reminder_id додано до таблиці maintenance_history"
        );
      }
    }
    ...
    if (!tableNames.includes("inventory")) {
      ...
      await db.exec(
        `CREATE INDEX idx_inventory_update_date ON inventory (update_date)`
      );
      ...
      for (const col of requiredInventoryColumns) {
        if (!inventoryColumns.some((c) => c.name === col.name)) {
          console.log(
            `Стовпець ${col.name} відсутній у таблиці inventory, додаємо...`
          );
          await db.exec(
            `ALTER TABLE inventory ADD COLUMN ${col.name} ${col.type}`
          );
          ...
          if (col.name === "updated_at") {
            ...
            console.log(
              `Значення для updated_at оновлено для існуючих записів у inventory`
            );
          }
        }
      }
    ...
    if (tableNames.includes("optimization") && !tableNames.includes("tasks")) {
      console.log(
        "Таблиця optimization існує, а tasks — ні. Перейменовуємо optimization на tasks..."
      );
      ...
      await db.exec(
        `CREATE INDEX idx_tasks_reminder_id ON tasks (reminder_id)`
      );
    ...
    async function insertInitialData(table, data, columns, logMessage) {
      ...
      if (count.count === 0) {
        ...
        for (const item of data) {
          ...
          // Створення масиву значень для вставки, де перевіряємо, що значення не undefined або null
          const values = columns.map((col) => {
            if (item[col] === undefined || item[col] === null) {
              return null; // Якщо значення відсутнє, ставимо null
            }
            return item[col]; // Інакше передаємо значення
          });
        ...
        console.log(
          `Таблиця ${table} вже містить дані (${count.count} записів), пропускаємо ініціалізацію.`
        );
      }
    }
    ...
    await insertInitialData(
      ...
      (item) =>
        `Додано техніку: name=${item.name}, type=${item.type}, price=${item.price}`
    );
    ...
    await insertInitialData(
      ...
      (reminder) =>
        `Додано нагадування: text=${reminder.text}, reminder_label=${reminder.reminder_label}, card_title=${reminder.card_title}, dateTime=${reminder.dateTime}, status=${reminder.status}`
    );
    ...
    await insertInitialData(
      ...
      (task) =>
        `Додано завдання: name=${task.name}, task_type=${task.task_type}`
    );
    ...
    console.log(
      "Фінальний список таблиць у базі даних:",
      finalTables.map((t) => t.name)
    );
